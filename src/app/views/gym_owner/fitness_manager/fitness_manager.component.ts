...
@Component({
    selector: 'app-fitness_manager',
    templateUrl: './fitness_manager.component.html',
    styleUrls: ['./fitness_manager.component.scss']
})
export class FitnessManagerComponent {
    ...
    refreshInfo() {
        ...
        url = EnvVariables.SERVER_ADDR + EnvVariables.FITNESS_MANAGER;
    ...
    onConfirmManager() {
        ...
        let url = EnvVariables.SERVER_ADDR + EnvVariables.ADD_FITNESS_MANAGER;
    ...
    onConfirmDelete() {
        ...
        let url = EnvVariables.SERVER_ADDR + EnvVariables.DELETE_FITNTESS_MANAGER;
