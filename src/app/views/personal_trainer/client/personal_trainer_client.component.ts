...
@Component({
    selector: 'app-personal_trainer_client',
    templateUrl: './personal_trainer_client.component.html',
    styleUrls: ['./personal_trainer_client.component.scss']
})

export class PersonalTrainerClientComponent {
    ...
    refreshInfo() {
        let params = {
            ...
            TrainerId: this.storage.getValue('trainer_id')
        };
    ...
    displayWorkout(item) {
        localStorage.setItem('SEL_CLIENT_ID', item.id);
