...
@Component({
    ...
    templateUrl: './personal_trainer.component.html',
    styleUrls: ['./personal_trainer.component.scss']
})
export class PersonalTrainerComponent {
    ...
    refreshInfo() {
        ...
        let url;
        url = EnvVariables.SERVER_ADDR + EnvVariables.PERSONAL_TRAINER;
    ...
    showClientList(item) {
        this.storage.setValue('trainer_id', item.id);
        this.storage.setValue('trainer_name', item.name);
        this.router.navigate(['/personal_trainer/personal_trainer_client']);
    }
