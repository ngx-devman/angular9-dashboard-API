...
@Component({
    selector: 'app-tech-manager',
    templateUrl: './tech-manager.component.html',
    styleUrls: ['./tech-manager.component.scss']
})
export class TechManagerComponent {
    ...
    onConfirmManager() {
        ...
        let url = EnvVariables.SERVER_ADDR + EnvVariables.ADD_TECH_MANAGER;
    ...
    onConfirmDelete() {
        ...
        let url = EnvVariables.SERVER_ADDR + EnvVariables.DELETE_TECH_MANAGER;
