...
export class TechComponent {
    ...
    collapseId:any= -1;
    expandedId:any;
    listTitle = 'Technician List';
    listTableHeads = ['No', 'Name', 'Email', 'Phone Number', 'View'];
    ...
    getTechnician() {
        ...
        this.apiProvider.getTechnician().subscribe(response => {
            ...
            if (response['status'] == '1') {
                ...
                this.listTitle = `Technicians List (${this.techList.length})`;
            }
        })
    }
    ...
    updateSearch(event){
        this.searchOpt.techname = event.name;
        this.techList = this.filterSearch();
    }
}